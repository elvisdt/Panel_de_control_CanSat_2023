...
class App(customtkinter.CTk):
    ...
    def configure_C1_vent_info_sensor(self):
        ...
        #------------- Giroscopio-------------
        self.C1_vent_info_sensor.fig_frame_01.set_title(title="Lecturas del giroscopio")
        self.C1_vent_info_sensor.fig_frame_01.add_line(func="GX", label='gx', linewidth=0.6)
        self.C1_vent_info_sensor.fig_frame_01.add_line(func="GY", label='gy', linewidth=0.6)
        self.C1_vent_info_sensor.fig_frame_01.add_line(func="GZ", label='gz', linewidth=0.6)
        #self.vent_info_sensor.fig_frame_01.set_y_limits(-5,5)
        self.C1_vent_info_sensor.fig_frame_01.customize_legend(show=True, loc='lower left', title='Giroscopio')

        #------------- Magnetometro----------
        self.C1_vent_info_sensor.fig_frame_10.set_title(title="Lecturas del magnetómetro")
        self.C1_vent_info_sensor.fig_frame_10.add_line(func="MX", label='mx', linewidth=0.6)
        self.C1_vent_info_sensor.fig_frame_10.add_line(func="MY", label='my', linewidth=0.6)
        self.C1_vent_info_sensor.fig_frame_10.add_line(func="MZ", label='mz', linewidth=0.6)
        #self.vent_info_sensor.fig_frame_10.set_y_limits(-40, 40)
        self.C1_vent_info_sensor.fig_frame_10.customize_legend(show=True, loc='lower left', title='Magnetómetro')

        #------------- Barometro-------------
        self.C1_vent_info_sensor.fig_frame_11.set_title(title="Presión atmosférica (hPa)")
        self.C1_vent_info_sensor.fig_frame_11.add_line(func="PA", label='Pa', linewidth=0.6)
        ...
        while not self.serial_obj.data_queue.empty():
            ...
            if "SenC1" in data:
                ...
                try:
                    ...
                    self.C1_vent_info_sensor.fig_frame_01.add_new_data(0, gyro_C1[0])
                    self.C1_vent_info_sensor.fig_frame_01.add_new_data(1, gyro_C1[1])
                    self.C1_vent_info_sensor.fig_frame_01.add_new_data(2, gyro_C1[2])

                    self.C1_vent_info_sensor.fig_frame_10.add_new_data(0, mag_C1[0])
                    self.C1_vent_info_sensor.fig_frame_10.add_new_data(1, mag_C1[1])
                    self.C1_vent_info_sensor.fig_frame_10.add_new_data(2, mag_C1[2])

                    self.C1_vent_info_sensor.fig_frame_11.add_new_data(0, pres_C1)
