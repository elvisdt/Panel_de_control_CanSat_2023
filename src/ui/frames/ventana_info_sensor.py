...
class VentanaInfoSensor(customtkinter.CTkFrame):
    def __init__(self, master,**kwargs):
        ...
        self.grid_columnconfigure((0), weight=1,minsize=100)    # columnas adaptables
        ...
        self.frame_00.grid(row=0, column=0, columnspan=2,  padx=(5, 0), pady=(5, 0), sticky="nsew")
        self.fig_frame_00 = RealPlotPerso(master=self.frame_00, max_points=100)

        self.frame_10 = customtkinter.CTkFrame(self)
        self.frame_10.grid(row=1, column=0,columnspan=2, padx=(5, 0), pady=(5, 5), sticky="nsew")
